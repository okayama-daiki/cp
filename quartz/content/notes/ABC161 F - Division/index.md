...
$N-1$の約数の個数が上の2番目の解（すべて減算によって$N=1$が得られるパターン）に対応し，1番目のいくつかの除算の末に得られる解というのは，約数の数がそう多くないことを考えると，約数を列挙した上でその一つ一つをナイーブに判定すればよい．
