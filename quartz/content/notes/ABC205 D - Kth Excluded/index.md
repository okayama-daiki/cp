...
正の整数列Aについて，各々の要素以下の数で，かつそれ以前の整数列に出現しない整数の個数をカウントしておく．
...
尚，インデックスを-1することから，ターゲットが`a_lower[0]`以下の値であった場合，即ち二分探索して，0が返ってくるような場合はは別途処理が必要である．
