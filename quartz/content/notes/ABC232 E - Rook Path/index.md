...
$O(HWmax(H,W)K)$のとんでもDPを思いつくが，間に合うわけもなく．それでも他にすることがないため，実際に実装しDPテーブルを見てみると，各テーブルにおいて4種類の値しかとらないことに気付く．
(x1, y1)
(x1, *)
(*, y1)
それ以外
...
よってこれらの4種類のみを管理するDPを行えば良い．遷移も定義から考えばそんなに難しくないはず．状態圧縮というらしい．
